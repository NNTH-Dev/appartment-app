...
class _QrScannerState extends State<QrScanner>{
  ...
  Widget buildResult() => Container(
    ...
    // ),
    child: Text(
    barcodeQR != null ? 'Đã hoàn thành vui lòng quay lại' : 'Quét mã QR tại đây' ,
    maxLines: 3,
    style: TextStyle(
      color: barcodeQR != null ? Colors.greenAccent : Colors.white,
  ...
  Widget buildQrView(BuildContext context) => QRView(
    ...
    overlay: QrScannerOverlayShape(
      borderColor: barcodeQR == null ? Theme.of(context).accentColor : Colors.greenAccent,
      borderWidth:10,
      borderLength: 20,
      borderRadius: 10,
  ...
  void onQRViewCreated(QRViewController controller){
    ...
    controller.scannedDataStream.listen((barcode)=>setState((){ barcodeQR = barcode; }));
  }
}
